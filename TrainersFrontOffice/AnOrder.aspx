...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="CustomerIDlbl" runat="server" style="z-index: 1; left: 39px; top: 58px; position: absolute; height: 18px; width: 82px;" Text="Customer ID:"></asp:Label>
        ...
        <asp:Label ID="OrderValuelbl" runat="server" style="z-index: 1; left: 38px; top: 175px; position: absolute; margin-bottom: 0px" Text="Order Value:"></asp:Label>
